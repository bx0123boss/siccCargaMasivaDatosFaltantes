...
public class SICC_ESTADO_FLUJO_EFECTIVO {
    ...
    public boolean validaRegistro(String registro) throws Exception {
        ...
        expRegular.append("-?\\d{0,16}+[\\.]?+\\d{0,2}+\\|"); // IMPORTE numeros negativos
    ...
    public void insertaCarga(String registro, short numeroInstitucion, String nombreArchivo, String folioLote, int noLayout, String idUsuario, String macAddress) throws Exception {
        ...
        try {
            ...
            query.append("INSERT INTO SICC_ESTADO_FLUJO_EFECTIVO_LO(");
    ...
    public void procesoAltaModificacion(short numeroInstitucion, int noLayout, String fechaProceso, String folioLote, String idUsuario, String macAddress) throws Exception {
        ...
        try {
            ...
            query.append("  AND ISC.TABLE_NAME = 'SICC_ESTADO_FLUJO_EFECTIVO' ");
            ...
            query.append("     FROM SICC_ESTADO_FLUJO_EFECTIVO AS SFT ");
            ...
            while (i < listDatos.size()) {
                try {
                    ...
                    bd.setAutoCommit(false);
                    query.setLength(0);
                    query.append("INSERT INTO LOG_SICC_ESTADO_FLUJO_EFECTIVO (");
                    query.append("  NUMERO_INSTITUCION ");
                    query.append("  ,FECHA_MODIFICACION ");
                    query.append("	,CUENTA_CNBV_R13 ");
                    query.append("	,IMPORTE ");
                    ...
                    query.append("  ,'").append(idUsuario).append("'");
                    query.append("  ,'").append(macAddress).append("'");
                    query.append("FROM SICC_ESTADO_FLUJO_EFECTIVO ");
                    ...
                    query.setLength(0);
                    query.append("UPDATE SICC_ESTADO_FLUJO_EFECTIVO ");
                    query.append("SET ");
                    ...
                    bd.rollback();
                    query.setLength(0);
                    query.append("UPDATE SICC_ESTADO_FLUJO_EFECTIVO_LO ");
    ...
    public static void main(String arg[]) {
    	SICC_ESTADO_FLUJO_EFECTIVO obj = new SICC_ESTADO_FLUJO_EFECTIVO();
        String registro = "-123456789012345.12|";
        
         StringBuffer expRegular = new StringBuffer();
         expRegular.append("-?\\d{0,16}+[\\.]?+\\d{0,2}+\\|");
